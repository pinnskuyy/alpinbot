...
const
{
   WAConnection,
   MessageType,
   Presence  const qrcode = require("qrcode-terminal");
const moment = require("moment");
const cheerio = require("cheerio");
const get = require('got')
const fs = require("fs");
...
conn.sendMessage(id, 'Waalaikumsalam, ada yang bisa saya bantu? kalo bingung ketik #help ya say.., Jangan Lupa Follow IG OwnerBot https://instagram.com/pinnskuyy' ,MessageType.text);
}
else if (text == 'salam'){
...
conn.sendMessage(id, 'Maaf, Saat ini sedang tidak bisa menggunakan fitur sticker, Jangan lupa Donasi Ya Ke No wa.me//6285889074523' ,MessageType.text);
}
else if (text == '#stiker'){
conn.sendMessage(id, 'Maaf, Saat ini sedang tidak bisa menggunakan fitur sticker, Jangan lupa Donasi Ya Ke No wa.me//6285889074523' ,MessageType.text);
}
...
conn.sendMessage(id, 'Sama sama, semoga harimu menyenangkan,:) jangan lupa Follow IG OwnerBot https://instagram.com/pinnskuyy' ,MessageType.text);
}
else if (text == '#donate'){
const corohelp = await get.get('https://covid19.mathdro.id/api/countries/id').json()
var date = new Date();
